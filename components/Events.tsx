      ...
      <article className="group glass-card border border-kai-gold/10 hover:border-kai-gold/35 transition-all duration-500 overflow-hidden h-full flex flex-col">
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <a
            ...
            className="block text-center py-3 border border-kai-gold text-kai-gold text-xs tracking-[0.2em] uppercase hover:bg-kai-gold hover:text-kai-black transition-all duration-300 mt-auto"
          >
            Book Now
          </a>
        </div>
